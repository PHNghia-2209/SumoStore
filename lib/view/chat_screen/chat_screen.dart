...
import 'package:emart/controller/chat_controller.dart';
import 'package:emart/services/filestore_services.dart';
import 'package:emart/view/chat_screen/components/sender_bubble.dart';
          ...
          children: [
            Obx(
              () => controller.isLoading.value
                  ...
                  : Expanded(
                      child: StreamBuilder(
                          stream: FireStoreService.getChatMessage(
